      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          >
            ...
            <span className="text-sm font-medium text-slate-300">Study smarter with AI 2.0</span>
          </motion.div>
          ...
          >
            ...
            <button className="w-full sm:w-auto glass-card text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-slate-800/50 transition-colors">
              View Demo
            </button>
          </motion.div>
        ...
        >
          ...
          <div className="glass-card rim-light-border rounded-2xl overflow-hidden shadow-2xl relative z-10">
            ...
            <div className="bg-navy-900/90 border-b border-slate-700/50 px-4 py-3 flex items-center gap-2">
              ...
              <div className="mx-auto bg-navy-800/50 rounded-md px-4 py-1 text-xs text-slate-400 flex items-center gap-2">
            ...
            {/* Mockup Body */}
            <div className="p-6 bg-navy-900/50 grid grid-cols-12 gap-6 h-[400px]">
              {/* Sidebar */}
              <div className="col-span-3 space-y-4">
                <div className="h-10 rounded-lg bg-slate-800/50 flex items-center px-4 gap-3 text-slate-300">
              ...
              <div className="col-span-9 flex flex-col gap-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-slate-400">You have 3 topics to review today.</p>
                  </div>
                  <div className="h-10 px-4 bg-blue-600/20 text-blue-400 rounded-lg flex items-center justify-center text-sm font-medium border border-blue-500/20">
                    Generate Quiz
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="h-2 w-4/6 bg-slate-700/50 rounded-full"></div>
                  </div>
                </motion.div>
              </div>
            </div>
